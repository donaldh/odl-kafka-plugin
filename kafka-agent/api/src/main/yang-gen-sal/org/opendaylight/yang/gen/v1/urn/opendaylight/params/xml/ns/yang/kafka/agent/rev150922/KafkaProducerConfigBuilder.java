...
public class KafkaProducerConfigBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.kafka.agent.rev150922.KafkaProducerConfig> {
    ...
    private java.lang.String _defaultMessageSource;
    ...
    private java.lang.String _eventSubscriptions;
    ...
    public KafkaProducerConfigBuilder(KafkaProducerConfig base) {
        ...
        this._defaultMessageSource = base.getDefaultMessageSource();
        ...
        this._eventSubscriptions = base.getEventSubscriptions();
    ...
    public java.lang.String getDefaultMessageSource() {
        return _defaultMessageSource;
    }
    ...
    public java.lang.String getEventSubscriptions() {
    ...
    public KafkaProducerConfigBuilder setDefaultMessageSource(java.lang.String value) {
        this._defaultMessageSource = value;
        return this;
    }
    ...
    public KafkaProducerConfigBuilder setEventSubscriptions(java.lang.String value) {
    ...
    private static final class KafkaProducerConfigImpl implements KafkaProducerConfig {
        ...
        private final java.lang.String _defaultMessageSource;
        ...
        private final java.lang.String _eventSubscriptions;
        ...
        public int hashCode() {
            ...
            result = prime * result + ((_defaultMessageSource == null) ? 0 : _defaultMessageSource.hashCode());
            ...
            result = prime * result + ((_eventSubscriptions == null) ? 0 : _eventSubscriptions.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (_defaultMessageSource == null) {
                if (other.getDefaultMessageSource() != null) {
                    return false;
                }
            } else if(!_defaultMessageSource.equals(other.getDefaultMessageSource())) {
                return false;
            }
            ...
            if (_eventSubscriptions == null) {
                if (other.getEventSubscriptions() != null) {
                    return false;
                }
            } else if(!_eventSubscriptions.equals(other.getEventSubscriptions())) {
                return false;
            }
        ...
        public java.lang.String toString() {
            ...
            if (_defaultMessageSource != null) {
                ...
                builder.append("_defaultMessageSource=");
                builder.append(_defaultMessageSource);
             }
            if (_dpMessageHostIpXpath != null) {
                if (first) {
            ...
            if (_eventSubscriptions != null) {
                ...
                builder.append("_eventSubscriptions=");
                builder.append(_eventSubscriptions);
             }
            if (_messageSerialization != null) {
                if (first) {
